    ...
    <div class="service-product-content">
        <div class="service-product-brief clearfix">
            ...
            <div class="brief-text-box">
                ...
                <p>翼橙用独特的授课方式引导学生循序渐进学习计算机语言。
                    课程结合了东方系统性学习模式和西方的创新模式，
                    让孩子在专注力、逻辑思维、沟通技巧、动手操作能力得到更早的启蒙和更全方位的提升。
                    <br/>同时免费教授孩子咏春拳，我们始终认为强健的体魄是一切学习的灵魂！
                </p>
            </div>
        </div>
...
</section><!-- server mian product end -->